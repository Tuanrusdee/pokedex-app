    ...
    return (
        <div className=" w-[90%] m-[auto] max-w-[1100px]">
            <div className="flex justify-center">
                <img src="/images/Pok%3Fdex_3D_logo.webp" alt="logo" className="max-h-[80px] mt-[20px]" />
            </div>

            <div className="w-[90%] max-w-[600px] m-[auto]">
                <Link to={"/"} className="bg-[#0E61A7] px-[16px] py-[4px] rounded-[16px] font-semibold">Back</Link>
                {pokemon.data && (
                    <div className="  rounded-[20px] shadow overflow-hidden dark:border-gray-700  p-[16px] m-[auto]">
                        ...
                        <div className="py-5v bg-[#253641] rounded-[20px] p-[16px] my-[20px]">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-[20px] gap-y-[30px] ">
                                <div>
                                    <div className="flex gap-x-[10px]">
                                        <div className="text-[#0E61A7] font-semibold">Height</div>
                                        <div className="text-white" >{(pokemon.data.height / 10).toFixed(2)} m.</div>
                                    </div>
                                    <div className="flex gap-x-[10px]">
                                        <div className="text-[#0E61A7] font-semibold ">Weight</div>
                                ...
                                <div className='flex gap-2 justify-start sm:justify-end mt-[16px]'>
                                    {pokemon.data.types.map((item: { type: { name: string } }, index) => {
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-1 gap-[10px] mt-[16px]">
                                        {pokemon.data.abilities.map((item, index) => {
                                            return (<div
                                                ...
                                                className={`bg-[#0E61A7] capitalize px-[14px] py-1 rounded-[16px]`}
                                    ...
                                    <div className="grid grid-cols-1 gap-[10px] mt-[16px]">
                                        {pokemon.data.stats.map((item, index) => {
                                            return (<div className="flex gap-x-[10px] justify-between">
                                                <div key={index} className="text-[#0E61A7] font-semibold capitalize ">{item.stat.name}</div>
